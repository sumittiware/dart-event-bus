...
class EventBus {
  ...
  StreamController<EventMetadata> _streamController;

  /// Controller for the event bus stream.
  StreamController<EventMetadata> get streamController => _streamController;
  ...
  ///
  Stream<EventMetadata> on<EventMetadata>(Event type) {
    return streamController.stream.where((event) => event.type == type).cast();
  }

  /// Fires a new event on the event bus with the specified [event].
  ///
  void fire(EventMetadata event) {
